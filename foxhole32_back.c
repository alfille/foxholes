...
Bits LastTries[gamestate_space]; // Prior Tries index for back-reference
Bits LastIndexs[gamestate_space]; // Indexes corresponding to that Try
Bits WinStates[MaxDays];
